...
let convertArea = function convertArea(number, convertStr) {
    ...
    switch(convertStr) {
        ...
        case "㎢":
            ...
            resultArr.push(numberRound3(number * 100 + "ha"                                ));
        ...
        case "㎡":
            ...
            resultArr.push(numberRound3(number / 10000 + "ha"                              ));
        ...
        case "mi":
        case "mi²":
            resultArr.push(numberRound3(number * 2.59 + "km²"                                ));
            resultArr.push(numberRound3(number * (2.59e+6) + "m²"                           ));
            ...
            resultArr.push(numberRound3(number * 259 + "ha"                                 ));
        ...
        case "yd":
        case "y":
            resultArr.push(numberRound3(number / (1.196e+6) + "km²"                          ));
            resultArr.push(numberRound3(number / 1.196 + "m²"                               ));
            ...
            resultArr.push(numberRound3(number / 11960 + "ha"                               ));
        ...
        case "ft2":
        case "ft²":
            resultArr.push(numberRound3(number / (1.076e+7) + "km²"                          ));
            resultArr.push(numberRound3(number / 10.764 + "m²"                              ));
            ...
            resultArr.push(numberRound3(number / 107600 + "ha"                              ));
        ...
        case "in²":
        case "i":
            resultArr.push(numberRound3(number / (1.55e+9) + "km²"                           ));
            resultArr.push(numberRound3(number / 1550 + "m²"                                ));
            ...
            resultArr.push(numberRound3(number / (1.55e+7) + "ha"                           ));
            resultArr.push(numberRound3(number / (6.273e+6) + "acre"                        ));
            break;
        case "㏊":
        case "ha":
        case "h":
            resultArr.push(numberRound3(number / 100 + "km²"                                 ));
            resultArr.push(numberRound3(number * 10000 + "m²"                               ));
        ...
        case "ac":
        case "a":
            resultArr.push(numberRound3(number / 247.1 + "km²"                                 ));
            resultArr.push(numberRound3(number * 4047 + "m²"                               ));
            ...
            resultArr.push(numberRound3(number / 2.471 + "ha"                               ));
            break;
    }
