...
let convertLength = function convertLength(number, convertStr) {
    ...
    switch(convertStr) {
        ...
        case "k":
            ...
            break;
        case "m":
            resultArr.push(numberRound3(number / 1000 + "킬로미터"                                     ));
            ...
            resultArr.push(numberRound3(number * 1.094 + "야드"                                 ));
            ...
            break;
        case "cm":
            resultArr.push(numberRound3(number / 100000 + "킬로미터"                                   ));
            ...
            break;
        case "mm":
            resultArr.push(numberRound3(number / (1e+6) + "킬로미터"                                   ));
            resultArr.push(numberRound3(number / 1000 + "미터"                                      ));
        ...
        case "μm":
        case "um":
            resultArr.push(numberRound3(number / (1e+9) + "킬로미터"                                   ));
            ...
            break;
        case "nm":
            resultArr.push(numberRound3(number / (1e+12) + "킬로미터"                                  ));
        ...
        case "mil":
        case "mi":
            resultArr.push(numberRound3(number * 1.609 + "킬로미터"                                    ));
        ...
        case "yar":
        case "yd":
            resultArr.push(numberRound3(number / 1094 + "킬로미터"                                     ));
        ...
        case "f":
        case "\'":
            resultArr.push(numberRound3(number / 3281 + "킬로미터"                                     ));
        ...
        case "i":
        case "\"":
            resultArr.push(numberRound3(number / 39370 + "킬로미터"                                    ));
            ...
            break;
        case "nmi":
            resultArr.push(numberRound3(number * 1.852 + "킬로미터"                                    ));
